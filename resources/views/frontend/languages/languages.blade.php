                ...
                <div class="courses_container">
                    <div class="row courses_row">
                        ...
                        <div class="col-lg-6 course_col">
                            ...
                            <div class="course">
                                <div class="course_image"><img src="{{ asset('storage/' . $language->photo) }}" alt=""></div>
                                <div class="course_body">
                                    <h3 class="course_title"><a href="{{ route('front.languages.show', ['language' => $language->id]) }}">{{ $language->title }}</a></h3>
                                    <div class="course_teacher"><i class="fa fa-calendar"></i> {!! $new_date = date('d-m-Y', strtotime($language->created_at)) !!}</div>
                                ...
                                <div class="course_footer">
                                    <div class="course_footer_content d-flex flex-row align-items-center justify-content-start">
                                        <div class="course_price ml-auto">
                                            <a href="{{ route('front.languages.show', ['language' => $language->id]) }}" type="submit">{{ __('Davomi...')  }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
