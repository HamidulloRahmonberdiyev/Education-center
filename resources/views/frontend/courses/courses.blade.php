        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="courses_search_container">
                    <form action="{{ route('search') }}" method="GET" id="courses_search_form" class="courses_search_form d-flex flex-row align-items-center justify-content-start">
                        @csrf
                        ...
                        <div class="col-lg-6 course_col">
                            ...
                            <div class="course">
                                ...
                                <div class="course_body">
                                    ...
                                    <span><i class="{{ $course->icon }}"></i></span>
                                </div>
                                <div class="course_footer">
                                    <div class="course_footer_content d-flex flex-row align-items-center justify-content-start">
                                        <div class="course_price ml-auto">
                                            <a href="{{ route('front.courses.show', ['course' => $course->id]) }}" type="submit">{{ __('Davomi...') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="sidebar_latest">
                            ...
                            <div class="latest d-flex flex-row align-items-start justify-content-start">
                                ...
                                <div class="latest_content">
                                    ...
                                    <div class="latest_price"><a href="{{ route('front.languages.show', ['language' => $language->id]) }}">Ko'rish</a></div>
                                </div>
                            </div>
                            @endforeach
