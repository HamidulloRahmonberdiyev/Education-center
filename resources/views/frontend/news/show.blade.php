            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="blog_content">
                        <div class="blog_title">{{ $new->title }}</div>
                        <div class="blog_meta">
                            <ul>
                                <li>{{ __('Sana') }} <a href="/"><i class="fa fa-calendar"></i> {!! $new_date = date('d-m-Y', strtotime($new->created_at)) !!}</a></li>
                                <li><a href="/">Admin</a></li>
                            </ul>
                        </div>
                        <div class="blog_image"><img src="{{ asset('storage/' . $new->photo) }}" alt=""></div>
                        <p>{{ $new->content }}</p>
                    </div>
                    <div
                        ...
                        <div class="blog_tags">
                            ...
                            @foreach ($new->tags as $tag)
                                <ul>
                                    <li><a href="javascript:void();">{{ $tag->name }},</a></li>
                                </ul>
                            @endforeach
                        </div>
                            ...
                            <div class="sidebar_categories">
                                <ul>
                                    @foreach ($categories as $category)
                                        <li><a
                                                href="{{ route('front.categories.category', ['category' => $category->id]) }}">{{ $category->name }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </div>
                                ...
                                @foreach ($recent_courses as $course)
                                    <div class="latest d-flex flex-row align-items-start justify-content-start">
                                        ...
                                        <div class="latest_content">
                                            ...
                                            <div class="latest_price"><a
                                                    href="{{ route('front.courses.show', ['course' => $course->id]) }}">Ko'rish</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
