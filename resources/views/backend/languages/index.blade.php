...
<div class="mb-3">
    <a href="{{ route ('languages.create') }}" type="submit" class="btn btn-light text-success">Post qo'shish</a>
</div>
            <div class="row">
                            ...
                            <table class="table align-items-center table-flush table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{ route('languages.edit', ['language' => $language->id]) }}">{{ $language->title }}</a></td>
                                        <td>{{ $language->category->name }}</td>
                                        <td><img src="{{ asset('storage/' . $language->photo) }}" class="product-img" alt="product img"></td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item text-warning" href="{{ route('languages.edit', ['language' => $language->id]) }}"><i class="fa fa-pencil mr-1"></i> Tahrirlash</a>
